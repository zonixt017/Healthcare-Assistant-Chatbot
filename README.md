...
| `HF_INFERENCE_TASK` | `conversational` | Preferred HF inference task |
| `HF_INFERENCE_TASK_FALLBACKS` | `text-generation,conversational` | Backup tasks if provider rejects preferred task |
